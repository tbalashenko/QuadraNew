...
final class SizeConstants: ObservableObject {
    ...
    static let miniButtonImageSize: CGSize = CGSize(width: 18, height: 18)
    static let miniButtonSize: CGSize = CGSize(width: 18, height: 18)
    ...
    static let mediumButtonImageSize: CGSize = CGSize(width: 36, height: 36)
    static let mediumButtonSize: CGSize = CGSize(width: 36, height: 36)
    static let largeButtonSize: CGSize = CGSize(width: 48, height: 48)
    static let largeButtonImageSize: CGSize = CGSize(width: 48, height: 48)
    static let xLargeButtonSize: CGSize = CGSize(width: 100, height: 100)
    static let xLargeButtonImageSize: CGSize = CGSize(width: 100, height: 100)
